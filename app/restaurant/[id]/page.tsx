...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Butter - Ton guide resto parisien',
    description: 'Découvre, enregistre et partage tes meilleures adresses',
...
export default async function RestaurantPage({ params }: Props) {
  ...
  return (
    <>
      <RedirectClient />
      {/* Cette partie ne sera jamais visible à cause de la redirection,
          mais on garde le même contenu que la landing page au cas où */}
